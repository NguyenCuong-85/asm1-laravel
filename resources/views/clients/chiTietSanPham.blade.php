                        ...
                        <div class="swiper product-top">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide slider-top-img">
                                    <img src="{{Storage::url($san_pham->hinh_anh)}}" alt="img">
                                </div>
                                {{-- <div class="swiper-slide slider-top-img">
                                    <img src="{{asset('assets/clients/images/homepage-one/product-img/product-slider-img-1.webp')}}"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img">
                                    <img src="{{asset('assets/clients/images/homepage-one/product-img/product-slider-img-2.webp')}}"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img">
                                    <img src="{{asset('assets/clients/images/homepage-one/product-img/product-slider-img-3.webp')}}"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img">
                                    <img src="{{asset('assets/clients/images/homepage-one/product-img/product-slider-img-1.webp')}}"
                        ...
                        {{-- <div class="swiper product-bottom">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide slider-bottom-img">
                                    <img src="{{asset('assets/clients/images/homepage-one/product-img/product-img-16.png')}}" alt="img">
                                </div>
                                <div class="swiper-slide slider-bottom-img">
                                    <img src="{{asset('assets/clients/images/homepage-one/product-img/product-img-17.png')}}" alt="img">
                                </div>
                                <div class="swiper-slide slider-bottom-img">
                                    <img src="{{asset('assets/clients/images/homepage-one/product-img/product-slider-img-2.webp')}}"
                                        alt="img">
                ...
                <div class="col-md-6">
                    <div class="product-info-content" data-aos="fade-left">
                        ...
                        <div class="price">
                            ...
                            <span class="new-price">{{$san_pham->gia}}</span>
                        </div>
                        <p class="content-paragraph">   {{$san_pham->mo_ta}}
                        <hr>
                                ...
                                <div class="login-section account-section modal-main">
                                    <div class="review-form">
                                        <div class="review-content">
                                            ...
                                            <div class="close-btn">
                                                <img src="{{asset('assets/clients/images/homepage-one/close-btn.png')}}"
                                ...
                                <div class="wrapper-aurthor">
                                    <div class="wrapper-info">
                                        <div class="aurthor-img">
                                            <img src="{{asset('assets/clients/images/homepage-one/aurthor-img-1.webp')}}"
                                                alt="aurthor-img">
                                        </div>
...
<section class="product weekly-sale product-weekly footer-padding">
    <div class="container">
        ...
        <div class="weekly-sale-section">
            <div class="row g-5">
                @foreach ($san_pham_lien_quans as $item)
